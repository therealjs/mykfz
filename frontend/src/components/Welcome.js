            ...
            >
                <div className={classes.container}>
                    ...
                    <h2 className={classes.subtitle}>
                        my<span className={classes.colorText}>KFZ. </span> is an
                        online vehicle registration platform to enable citizens
                        to <br /> register and deregister cars and motorcycles
